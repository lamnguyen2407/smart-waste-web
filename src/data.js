...
export const BINS_DATA = [
  { id: "BIN-001", name: "Hoan Kiem Lake", lat: 21.0285, lng: 105.8542, fillLevel: 82, type: "General", status: "Critical", battery: 45, lastUpdate: "10 mins ago" },
  ...
  { id: "BIN-003", name: "St. Joseph's Cathedral", lat: 21.0288, lng: 105.8489, fillLevel: 48, type: "Organic", status: "Warning", battery: 65, lastUpdate: "1 hour ago" },
  { id: "BIN-004", name: "Hanoi Opera House", lat: 21.0254, lng: 105.8575, fillLevel: 88, type: "General", status: "Normal", battery: 95, lastUpdate: "5 mins ago" },
